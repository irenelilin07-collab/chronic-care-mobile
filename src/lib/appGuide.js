import { dateKeyFromDate, buildTasksForDate } from "./dailySchedule.js";
import { TABS } from "./storage.js";

const TASK_STEP_IDS = ["diseases", "medicine", "plan", "reminder", "checkin"];
...
export const APP_GUIDE_STEPS = [
  {
    ...
    title: "欢迎使用慢病用药小管家",
    description:
      "接下来会带您使用 App 的真实功能：录入慢病、添加药品、创建计划，并完成第一次打卡。",
    tab: null,
    optional: false,
  },
  {
  ...
  },
  {
    id: "checkin",
    title: "完成今日打卡",
    description: "请点击页面中高亮的用药任务卡片，完成第一次打卡。",
    completedDescription: "打卡已完成，点击「下一步」继续。",
    tab: TABS.today,
...
export function getGuideStepDescription(step, completed) {
  if (!step) return "";
